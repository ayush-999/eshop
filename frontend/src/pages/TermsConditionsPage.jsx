        ...
        <div className="grid grid-cols-12 gap-3">
          <div className="col-span-12 sideBar-wrapper">
            <div className="bg-white p-6 rounded-lg shadow-xs" id="">
              ...
              <h3 className="font-bold mt-2">Interpretation</h3>
              <p>
              ...
              <h3 className="font-bold mt-2">Definitions</h3>
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Eshop.
                  </p>
                </li>
                <li>
                  <p>
              ...
              <h2 className="text-lg font-bold mt-2">Acknowledgment</h2>
              <p>
              ...
              <h2 className="text-lg font-bold mt-2">Links to Other Websites</h2>
              <p>
              ...
              <h2 className="text-lg font-bold mt-2">Termination</h2>
              <p>
              ...
              <h2 className="text-lg font-bold mt-2">Limitation of Liability</h2>
              <p>
                Notwithstanding any damages that You might incur, the entire
                liability of the Company and any of its suppliers under any
                provision of this Terms and Your exclusive remedy for all of the
                foregoing shall be limited to the amount actually paid by You
                through the Service or 100 USD if You haven purchased anything
                through the Service.
              </p>
              <p>
              ...
              <p>
                ...
                these states, each party liability will be limited to the
              ...
              <p>
                ...
                the company provider makes any representation or warranty of any
              ...
              <h2 className="text-lg font-bold mt-2">Governing Law</h2>
              <p>
              ...
              <h2 className="text-lg font-bold mt-2">Disputes Resolution</h2>
              <p>
              ...
              <h2 className="text-lg font-bold mt-2">Severability and Waiver</h2>
              ...
              <p>
                ...
                affect a party ability to exercise such right or require such
                performance at any time thereafter nor shall the waiver of a
                breach constitute a waiver of any subsequent breach.
              </p>
              <h2 className="text-lg font-bold mt-2">Translation Interpretation</h2>
              <p>
              ...
              <h2 className="text-lg font-bold mt-2">Contact Us</h2>
              <p>
                If you have any questions about these Terms and Conditions, You
                can contact us:
              </p>
              <ul>
                <li>By email: support@eshop.com</li>
              </ul>
            </div>
          </div>
        </div>
