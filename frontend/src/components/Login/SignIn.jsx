                              ...
                              <Field
                                 ...
                                 className={`bg-gray-50 border ${
                                    errors.email && touched.email
                                       ...
                                       : 'border-gray-300'
                                 } text-gray-900 rounded-lg focus:border-primary-200 block w-full p-2.5`}
                              ...
                              <Field
                                 ...
                                 className={`bg-gray-50 border ${
                                    errors.password && touched.password
                                       ? 'border-primary-600 bg-primary-0'
                                       : 'border-gray-300'
                                 } text-gray-900 rounded-lg focus:border-primary-200 block w-full p-2.5 input-with-icon`}
                                 placeholder='••••••••'
